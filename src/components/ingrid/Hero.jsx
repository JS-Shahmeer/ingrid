...
export default function Hero() {
  ...
  return (
    <section className="relative md:min-h-[700px] md:h-full h-screen md:pt-44 w-full overflow-hidden">
      ...
      {/* Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-t from-black/0 via-black/0 to-black/50" />
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-6 text-center">
        ...
        <motion.div
          ...
          className="mb-3"
        >
          <span className="font-display text-5xl md:text-7xl font-light text-white/90 tracking-[0.05em]">
            IE
          </span>
        </motion.div>
        ...
        <motion.button
          ...
          className="mt-12 font-body bg-[#6E7B48] text-[11px] tracking-[0.2em] uppercase px-10 py-3.5  text-white hover:bg-white hover:text-[#1A1A1A] transition-all duration-500"
        >
          Discover More
        </motion.button>
      </div>
